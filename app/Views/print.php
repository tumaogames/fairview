...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://unligames.com/fairview/assets/mystyle.css">
    <style>
                ...
                if ($startId >= $rangeParts[0] && $endId <= $rangeParts[1] && $startId <= $endId) {
                    for ($voterId = $startId; $voterId <= $endId; $voterId++) {
                        ...
                        if ($voterInfo !== null) {
                            ...
                            echo '<div class="custom-col"><p></p></div>';
                            echo '<div class="col-3 custom-col px-1"><p>Address:</p></div>';
                            echo '<div class="col-9 custom-col"><span class="py-0" style="font-weight: bold">' . $voterInfo['address'] . '</span></div>';
                            echo '</div>';
                            echo '<div class="row mb-1">';
                            echo '<div class="custom-col"><p></p></div>';
                            echo '<div class="col-3 custom-col px-1"><p>Precinct:</p></div>';
                            echo '<div class="col-9 custom-col"><span class="py-0" style="font-weight: bold">' . $voterInfo['precinct_no'] . '</span></div>';
                            echo '</div>';
                            echo '<div class="row mb-1">';
                            echo '<div class="custom-col"><p></p></div>';
                            echo '<div class="col-3 custom-col px-1"><p>Cluster:</p></div>';
                            echo '<div class="col-9 custom-col"><span class="py-0" style="font-weight: bold">' . $voterInfo['clustered_precinct'] . '</span></div>';
                            echo '</div>';
